package com.ernoxin.fipiranapi.common.exception;

import com.ernoxin.fipiranapi.common.api.ApiResponse;
import com.ernoxin.fipiranapi.common.api.ErrorResult;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<ErrorResult>> handleUpstream(UpstreamApiException ex, HttpServletRequest request) {
        return buildError(ex.getStatus(), ex.getMessage(), List.of("Upstream FIPIRAN API call failed"), request, ex);
    }

    @ExceptionHandler(ResponseStatusException.class)
    public ResponseEntity<ApiResponse<ErrorResult>> handleResponseStatus(ResponseStatusException ex, HttpServletRequest request) {
